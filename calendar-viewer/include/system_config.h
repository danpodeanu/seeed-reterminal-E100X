...
constexpr uint32_t TOUCH_INACTIVITY_SLEEP_MS = 5UL * 60UL * 1000UL;
...
constexpr uint64_t NETWORK_CACHE_MAX_AGE_SECONDS = 15ULL * 60ULL;
constexpr uint64_t CALENDAR_FAILURE_CACHE_MAX_AGE_SECONDS = 6ULL * 60ULL * 60ULL;
constexpr uint64_t WEATHER_CACHE_MAX_AGE_SECONDS = 6ULL * 60ULL * 60ULL;
constexpr size_t MAX_CALENDAR_CACHE_BYTES = 768U * 1024U;
