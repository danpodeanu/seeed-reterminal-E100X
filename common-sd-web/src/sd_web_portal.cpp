...
void sendPageHeader(const String& title, const String& breadcrumbHtml) {
  ...
  html += F(
      ...
      "form.row{display:flex;gap:.6rem;margin-top:.5rem;flex-wrap:wrap;align-items:stretch}"
      "form.row input[type=text],form.row input[type=file]{flex:1 1 200px;min-width:0;padding:.6rem;border:1px solid #ccc;border-radius:6px;font-size:1rem;font-family:inherit;background:#fff;min-height:44px}"
