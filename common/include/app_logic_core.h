...
// Small pure predicates shared by every viewer app. Each app's
// include/app_logic.h pulls this header in and adds its app-specific
// extensions in the same namespace.
namespace app_logic {
