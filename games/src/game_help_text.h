...
inline constexpr const Utf8Char*
    kInstructions[kTopicCount][game_localization::kLanguageCount] = {
        ...
        {u8"Browse the SD card read-only and tap an EPUB file to open it. The "
         ...
         "before the text; otherwise cover.png or cover.jpg in the book's "
         "folder is used. UP FOLDER returns to the parent "
         ...
         "JPEG/PNG integradas aparecen antes del texto; si no hay una, se usa "
         "cover.png o cover.jpg de la carpeta del libro. SUBIR "
         ...
         "JPEG/PNG intégrées précèdent le texte; sinon cover.png ou cover.jpg "
         "du dossier du livre est utilisée. "
         ...
         "AUF und AB wechseln Buchseiten. Eingebettete JPEG/PNG-Cover erscheinen "
         "vor dem Text; sonst wird cover.png oder cover.jpg aus dem Buchordner "
         "verwendet. ORDNER "
         ...
         "阅读时使用侧边上、下键。内嵌 JPEG/PNG 封面会显示在正文之前；否则使用书籍文件夹中的 "
         "cover.png 或 cover.jpg。上级文件夹可返回父目录，"
         "阅读界面的返回箭头可回到浏览器。仅支"
