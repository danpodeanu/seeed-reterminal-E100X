#!/usr/bin/env python3
"""Generate embedded styled Latin fonts for the Games EPUB reader."""
...
OUTPUT_HEADER = ROOT / "games" / "src" / "epub_latin_fonts.h"
PIXEL_SIZE = 24
...
def main() -> int:
    ...
    output = (
        "#pragma once\n\n"
        "#include <Arduino.h>\n\n"
        "// Generated by games/tools/generate_epub_latin_fonts.py from Noto Serif.\n"
