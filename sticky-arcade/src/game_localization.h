...
inline constexpr const Utf8Char*
    ...
    {u8"FALLING BLOCKS", u8"BLOQUES QUE CAEN", u8"BLOCS TOMBANTS",
     u8"FALLENDE BLÖCKE", u8"下落方块"},
    ...
    {u8"LINES", u8"LÍNEAS", u8"LIGNES", u8"REIHEN", u8"行数"},
    {u8"GAME OVER", u8"FIN DEL JUEGO", u8"PARTIE TERMINÉE", u8"SPIELENDE",
     u8"游戏结束"},
