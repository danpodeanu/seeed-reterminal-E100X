#!/usr/bin/env python3
"""Generate flash-backed VLW arrays for the localized Sticky Arcade interface."""
...
LOCALIZATION_HEADER = ROOT / "sticky-arcade" / "src" / "game_localization.h"
HELP_TEXT_HEADER = ROOT / "sticky-arcade" / "src" / "game_help_text.h"
OUTPUT_HEADER = ROOT / "sticky-arcade" / "src" / "game_ui_fonts.h"
...
def main() -> int:
    ...
    output = (
        "#pragma once\n\n"
        "#include <Arduino.h>\n\n"
        "// Generated by sticky-arcade/tools/generate_ui_fonts.py from Noto Sans CJK SC Bold.\n"
