...
const Field kPresentationFields[] = {
    ...
    {kKeyClutterFree,
     ...
     FieldType::Bool, "true", nullptr, 0, 0, nullptr},
    {kKeyWeatherBackground,
     "Weather background",
     "Show a bundled ink-wash landscape behind the main render. Turn off for a plain white background.",
     FieldType::Bool, "true", nullptr, 0, 0, nullptr},
    {kKeyNwsAlerts,
...
const Field kBatteryFields[] = {
    {kKeyLowBatteryWarn,
     ...
     "When the battery drops below 5% (on boards with a battery sensor), replace the forecast with a 'please recharge' screen.",
     FieldType::Bool, "true", nullptr, 0, 0, nullptr},
};
