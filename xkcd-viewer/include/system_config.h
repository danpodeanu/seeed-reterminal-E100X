...
constexpr char CACHE_INDEX[] = "/xkcd/index.jsonl";
constexpr char CACHE_INDEX_LEGACY_JSON[] = "/xkcd/index.json";
constexpr char CACHE_INDEX_LEGACY_TXT[] = "/xkcd/index.txt";
constexpr char CACHE_LATEST_LEGACY[] = "/xkcd/latest.json";
constexpr uint32_t CACHE_INDEX_VERSION = 5;
