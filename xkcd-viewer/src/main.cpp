...
// bitmap FreeFonts.  Sizes 13/17/25/33 are generated by
// tools/make_vlw.py and are expected at /fonts/xkcd_<size>.vlw on SD.
#if RETERMINAL_MODEL == 1003
constexpr int SMOOTH_FONT_TITLE_PX = 33;
constexpr int SMOOTH_FONT_FOOTER_PX = 25;
#elif RETERMINAL_MODEL == 1004
constexpr int SMOOTH_FONT_TITLE_PX = 25;
constexpr int SMOOTH_FONT_FOOTER_PX = 17;
#else
constexpr int SMOOTH_FONT_TITLE_PX = 17;
constexpr int SMOOTH_FONT_FOOTER_PX = 13;
#endif
...
static bool smoothFontFileExists(int size) {
  ...
  return SD.exists(String("/fonts/xkcd_") + size + ".vlw");
}
...
static void applySmoothFont(int size, const GFXfont* fallback) {
  ...
  if (!smoothFontFileExists(size)) {
    LOG.printf("[font] /fonts/xkcd_%d.vlw missing; falling back to GFX font\n",
               size);
  ...
  epaper.loadFont(String("xkcd_") + size, SD);
...
void selectTitleFont() {
  applySmoothFont(SMOOTH_FONT_TITLE_PX,
#if RETERMINAL_MODEL == 1003
                  &FreeSansBold24pt7b
#elif RETERMINAL_MODEL == 1004
                  &FreeSansBold18pt7b
...
void selectFooterFont() {
  applySmoothFont(SMOOTH_FONT_FOOTER_PX,
#if RETERMINAL_MODEL == 1003
                  &FreeSansBold18pt7b
#elif RETERMINAL_MODEL == 1004
                  &FreeSansBold12pt7b
