...
// bitmap FreeFonts.  DejaVu Sans's cap-height is ~0.73x the em size PIL
// reports, so the smooth-font pixel sizes are chosen so the cap-height
// visually matches the GFX FreeSansBold fallback at the same role.  Files
// are generated by tools/fonts/make_vlw.py as /fonts/sans_bold_<size>.vlw on SD.
#if RETERMINAL_MODEL == 1003
constexpr int SMOOTH_FONT_TITLE_PX = 48;   // matches FreeSansBold24pt7b
constexpr int SMOOTH_FONT_FOOTER_PX = 36;  // matches FreeSansBold18pt7b
#elif RETERMINAL_MODEL == 1004
constexpr int SMOOTH_FONT_TITLE_PX = 36;   // matches FreeSansBold18pt7b
constexpr int SMOOTH_FONT_FOOTER_PX = 24;  // matches FreeSansBold12pt7b
#else
constexpr int SMOOTH_FONT_TITLE_PX = 24;   // matches FreeSansBold12pt7b
constexpr int SMOOTH_FONT_FOOTER_PX = 18;  // matches FreeSansBold9pt7b
#endif
